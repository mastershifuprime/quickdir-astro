          ...
          <>
            {finalResult.map((result, index) => (
              <button
                ...
                className={`flex items-center px-4 py-2 text-base text-text border-dark/10 border rounded-md cursor-pointer ${
        ...
        <div className="search-result">
          {finalResult.length > 0 ? (
            finalResult
              ...
              .map((result) => (
                <div
                  className="search-result-group relative"
                  key={result.group}
                >
                  {result.groupItems.map((item) => {
                    const isRedFlag =
                      (item.frontmatter as any).redFlag || false;
                    return (
                      <div
                        key={item.slug}
                        id="searchItem"
                      ...
                      >
                          ...
                          <img
                            src={
                              result.group === "resources"
                                ...
                                : (item.frontmatter.image as string)
                            }
                        ...
                        <div className="search-result-item-body">
                          <a
                            ...
                            target={
                              item.frontmatter.externalURL ? "_blank" : "_self"
                            }
                            className="search-result-item-title stretch-link"
                          >
                            {matchUnderline(
